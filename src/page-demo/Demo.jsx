...
import { innerPageDemo } from "./script";
import { testimonialActivation } from "./script";
...
import demoHome from "../assets/images/preview/demo-home.png";
import darkMainDemo from "../assets/images/preview/dark-main-demo.png";
...
import creativeAgency from "../assets/images/preview/creative-agency.png";
...
import digitalAgency from "../assets/images/preview/digital-agency.png";
import business from "../assets/images/preview/business.png";
import startup from "../assets/images/preview/startup.png";
import paralax from "../assets/images/preview/paralax.png";
import studioAgency from "../assets/images/preview/studio-agency.png";
import comingSoon from "../assets/images/preview/coming-soon.png";
...
import waveIcon from "../assets/images/icons/wave-icon.png";
import phone from "../assets/images/icons/phone.png";
import tablet from "../assets/images/icons/tablet.png";
import desktop from "../assets/images/icons/desktop.png";
import gallery from "../assets/images/bg/gallery.png";
              ...
              <div className="col-lg-8 col-xl-5">
                <div className="inner">
                  <div className="logo text-left">
                    <a href="/">
                      <img src={logoAllDark} alt="Trydo Images" />
                    </a>
                  </div>
                  <p className="title">
      ...
      <div className="main-wrapper" id="demo">
              ...
              <div className="col-lg-12">
                <div className="section-title text-center pb--30 pb_sm--0 pb_md--0">
                  ...
                  <p className="text-white">
                    Trydo are designed for everyone. It doesn’t matter if you’re
                    a React <br />
        ...
        <div className="gt-matrik-score-area ptb--120 bg_color--1">
            ...
            <div className="row row--35">
              <div className="col-lg-6 col-md-12 col-12">
                <div className="inner">
                  ...
                  <p>
                    Trydo Page speed is so faster and takes byte times for load
                    each page. It's is very easy to use, loads faster and
          ...
          <div className="shape-images">
            <img src={waveIcon} alt="Wave Images" />
          </div>
        </div>
                ...
                <div className="inner">
                  <div className="section-title">
                    ...
                    <p>
                      ...
                      compromise, will always looks cool and great on any mobile
                      device or browsers. Its easily adapt your content for
                  ...
                  <div className="responsive-layout-mokup">
                    <div className="mokup-list">
                      <div className="icon">
                        <img src={phone} alt="icon Images" />
                      </div>
                      <h6>Phone</h6>
                    </div>
                    <div className="mokup-list">
                      <div className="icon">
                        <img src={tablet} alt="icon Images" />
                      </div>
                      <h6>Tablet</h6>
                    </div>
                    <div className="mokup-list">
                      <div className="icon">
                        <img src={desktop} alt="icon Images" />
                      </div>
                      <h6>Desktop</h6>
                    </div>
                  </div>
                  ...
                  <Accordion className="accodion-style--1" preExpanded={"0"}>
                    <AccordionItem>
                      ...
                      <AccordionItemPanel>
                        <p>
                          ...
                          faster, use to use and Well Documented Codes for your
                          customization.
                        </p>
                      </AccordionItemPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem>
                      ...
                      <AccordionItemPanel>
                        ...
                        <p>
                          At Last: <strong>yarn start</strong>. By the following
                      ...
                      <AccordionItemPanel>
                        <div>
                          <p>
                            ...
                            any page as your you are like. First you have to go
                            index.js page then:
                          </p>
                          <p>
                            First Step (replace your choose demo page): Example:
                            import Demo form './home/MainDemo' Instead of
                      ...
                      <div className="inner">
                        <div className="inner-top">
                          <div className="thumbnail">
                            <img src={download} alt="Download Images" />
                          </div>
                          <div className="info">
                        ...
                        <div className="content">
                          ...
                          <p>
                            ...
                            are also the author on Envato and our requirement is
                            very high, Affordable and excellent...
                          </p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Perfectly support. Well deserved 5 star for code and
                            design quality.
                          </p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="inner text-center">
                  <span>
                    Purchase The TryDo and Make Your Site super faster and easy.
                  </span>
